...
const faqItems = [
  {
    ...
    answer:
      '네, 가능해요. "My favorite movie is Titanic. I like the acting." 정도로 좋아하는 걸 영어로 말할 수 있다면 충분합니다. 문장이 완벽하지 않아도, 조금 더듬거려도 괜찮아요. The Round은 \'영어 잘하는 사람들의 모임\'이 아니라, 편하게 입을 떼보는 자리니까요.'
  },
  {
